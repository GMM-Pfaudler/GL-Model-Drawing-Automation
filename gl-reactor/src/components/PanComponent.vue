  ...
  <div class="q-pa-md" style="height: 100vh; display: flex; flex-direction: column;">
    ...
    <div class="q-mb-md">
      <div class="row q-gutter-md q-wrap">
        ...
        <q-space/>
        <q-btn outline rounded icon="search" color="primary" label="Search" @click="searchPanData"/>
      </div>
    </div>
...
export default {
  ...
  setup (props, { emit }) {
    ...
    const searchPanData = () => {
        const panData = preparePanData()
        emit('search-data', panData)
    }

    const preparePanData = () => {
        const panData = {
            component: 'Pan',
